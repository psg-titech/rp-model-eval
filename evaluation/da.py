"""
DA model, Preemptive Scheduling, Nonpreemptive Schedulingの比較
"""
...
def test(u_sum, times) -> tuple[int, int, int]:
    n = 15
    min_period = 500
    max_period = 5000
    ...
    return num_schedulable_preemptive, num_schedulable_nonpreemptive, num_schedulable_da
...
def main():
    ...
    ax.plot(us, ratio_schedulable_nonpreemptive, label="Nonpreemptive")
    ax.plot(us, ratio_schedulable_da, label="DA model")
    ax.plot(us, ratio_schedulable_preemptive, label="Preemptive", linestyle="--")
